...
Optional admin UI auto sign-in: $CLAUDIA_GATEWAY_TOKEN (same value as a row in tokens.yaml; GET /ui/login sets the session cookie when unset in the browser).
